...
const StyledWrapper = styled.div`
  ...
  .card:hover {
    box-shadow: 0px 0px 40px 4px rgba(0, 255, 117, 0.3);
  }

  @keyframes pulseGlow {
    0%, 100% { box-shadow: 0 0 16px 2px rgba(0, 255, 117, 0.15); }
    50%       { box-shadow: 0 0 32px 4px rgba(55, 0, 255, 0.2); }
  }
  ...
  .button2:hover {
    ...
    border-color: rgba(55, 0, 255, 0.4);
    transform: scale(0.97);
  }
